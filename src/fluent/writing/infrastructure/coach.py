...
PATTERNS = (
    ...
    {
        "key": "gram-present-perfect-vs-past",
        "category": "grammar",
...
def turn(generate, topic: str, level: str, turns: list[dict], text: str) -> dict:
...
def close(generate, topic: str, level: str, turns: list[dict]) -> dict:
